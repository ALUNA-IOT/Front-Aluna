      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-slate-400 text-lg">
            Consulta nuestros espacios y sus tarifas por hora
          </p>
        </div>
              ...
              <div className="p-6 border-t border-primary/20">
                <button
                  ...
                  className={`w-full py-3 rounded-lg font-semibold transition-colors ${
                    space.available
                      ? 'bg-orange-500/40 text-orange-300 hover:bg-orange-500/50 shadow-lg shadow-orange-500/30 border border-orange-500/70'
